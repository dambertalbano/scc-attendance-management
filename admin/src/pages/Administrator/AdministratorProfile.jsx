...
const AdministratorProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(AdministratorContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/administrator/update-profile', updateData, { headers: { dToken } })
