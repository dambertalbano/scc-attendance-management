...
const UtilityProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(UtilityContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/utility/update-profile', updateData, { headers: { dToken } })
