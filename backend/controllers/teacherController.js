...
// API to change teacher availablity for Admin and Teacher Panel
const changeAvailablity = async (req, res) => {
    try {

        const { docId } = req.body

        const docData = await teacherModel.findById(docId)
        await teacherModel.findByIdAndUpdate(docId, { available: !docData.available })
...
export { appointmentCancel, appointmentComplete, appointmentsTeacher, changeAvailablity, loginTeacher, teacherDashboard, teacherList, teacherProfile, updateTeacherProfile };
